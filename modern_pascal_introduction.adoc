...
Note: you could also make a valid argument that above example could be split into 3 separate procedures, one calling each other, in this simple case.
