...
+
Note that the value of the loop counter variable (`I` in this example) is undefined after the loop has finished. Unless you exited the loop prematurely by `Break` or `Exit`.
